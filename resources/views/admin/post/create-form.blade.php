            ...
            <form action="{{route('admin.post.save')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    <div class="form-group">
                        <label for="title">Заголовок Поста Ru</label>
                        <input type="text" class="form-control" id="title_ru" name="title_ru" value="{{old('title_ru')}}" placeholder="Название">
                        @error('title_ru')
                        ...
                        <div class="form-group">
                            <label for="title">Заголовок Поста Eng</label>
                            <input type="text" class="form-control" id="title" name="title" value="{{old('title')}}" placeholder="Name Title">
                            @error('title')
                            <div class="text-danger">{{$message}}</div>
                            @enderror
                        </div>
                    ...
                    <div class="form-group">
                        <label for="title">Контент Ru</label>
                        <textarea id="summernote_ru" name="content_ru">{{old('content_ru')}}</textarea>
                        @error('content_ru')
                        <div class="text-danger">{{$message}}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        <label for="title">Контент Eng</label>
                    ...
                    <div class="form-group w-25" >
                        ...
                        <select class="custom-select" name="category_id">
                            ...
                            @foreach($categories as $category)
                                ...
                                >{{$category->title_ru}} / {{$category->title}} </option>
                                @endif
                            @endforeach
                        </select>
            ...
            @if(isset($post))
                <form action="{{route('admin.post.update',$post->id)}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <label for="title">Заголовок Поста Ru</label>
                            <input type="text" class="form-control" id="title_ru" name="title_ru" value="{{$post->title_ru}}">
                            @error('title_ru')
                            <div class="text-danger">{{$message}}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            <label for="title">Контент Ru</label>
                            <textarea id="summernote_ru" name="content_ru">{{$post->content_ru}}</textarea>
                            @error('content_ru')
                            <div class="text-danger">{{$message}}</div>
                            @enderror
                        </div>
